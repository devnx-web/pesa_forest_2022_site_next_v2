                    ...
                    >
                        <div>
                            ...
                            >
                                <Row>
                                    <Col>
                                    <div><Link href="/maquinas/logset/4fgt"><a className="textofaq">4FGT</a></Link></div>
                                    <div><Link href="/maquinas/logset/5hpgt"><a className="textofaq">5HPGT</a></Link></div>
                                    <div><Link href="/maquinas/logset/6hpgte"><a className="textofaq">6HPGTE</a></Link></div>
                                    ...
                                    <Col>
                                    <div><Link href="/maquinas/logset/5fpgt"><a className="textofaq">5FPGT</a></Link></div>
                                    <div><Link href="/maquinas/logset/6fgt"><a className="textofaq">6FGT</a></Link></div>
