...
export default function Mobile(){
    return(
        ...
        <div className={'bgmobile'}>
            <Container>
                <div>
                    <h1 className={'ttmaq2'}>B458</h1>
                    <h1 className={'ttmaq1'}>B458</h1>
                    <div>
            ...
            <div className={'desc'}>
                ...
                <p className={'textodesc'}>
                    ...
                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/b458-spec-sheet-t4-2.pdf"><a target="_blank"><div className={'botaodw'}>
