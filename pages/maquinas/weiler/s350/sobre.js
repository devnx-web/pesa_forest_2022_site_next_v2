                ...
                <div className={css.ocultamob}>
                    <div className={css.s250}>
                        <Container>
                            <Row>
                                <Col md="5">
                                    <h2 className={css.ttmaq2}>S 350</h2>
                                    <h2 className={css.ttmaq1}>S 350</h2>
                                    <h3 className={css.destaque}>Frase destaque</h3>
                                    <div>
                                        <p className={css.textomaq}>
                                        Proporcionam maior confiabilidade e durabilidade com transmissão Powershift e lock up, que fornece uma tração potente enquanto um sistema hidráulico multifunção forte melhora o desempenho geral.                                  </p>
                                    </div>
                                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/s350-spec-sheet-us-canada.pdf"><a target="_blank"><div className={css.botaosaber}>
