                ...
                <div className={css.ocultamob}>
                    <div className={css.s250}>
                        <Container>
                            <Row>
                                <Col md="5">
                                    <h2 className={css.ttmaq2}>S 450</h2>
                                    <h2 className={css.ttmaq1}>S 450</h2>
                                    ...
                                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/s450-spec-sheet-us-canada.pdf"><a target="_blank"><div className={css.botaosaber}>
