...
import img from "../../../../public/maquinas/m860.png"
...
export default function Mobile(){
    return(
        ...
        <div className={'bgmobile'}>
            <Container>
                <div>
                    <h1 className={'ttmaq2'}>M860</h1>
                    <h1 className={'ttmaq1'}>M860</h1>
                    <div>
            ...
            <div className={'desc'}>
                ...
                <p className={'textodesc'}>
                    ...
                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/m860-spec-sheet.pdf"><a target="_blank"><div className={'botaodw'}>
