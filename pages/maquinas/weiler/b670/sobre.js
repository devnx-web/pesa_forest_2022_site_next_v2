                ...
                <div className={css.ocultamob}>
                    <div className={css.s250}>
                        <Container>
                            <Row>
                                <Col md="5">
                                    <h2 className={css.ttmaq2}>B 670</h2>
                                    <h2 className={css.ttmaq1}>B 670</h2>
                                    ...
                                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/b670-spec-sheet-2.pdf"><a target="_blank"><div className={css.botaosaber}>
