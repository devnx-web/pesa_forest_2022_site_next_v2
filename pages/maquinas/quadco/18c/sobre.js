                ...
                <div className={css.ocultamob}>
                    <div className={css.s250}>
                        <Container>
                            <Row>
                                <Col md="5">
                                    <h2 className={css.ttmaq2}>18 C</h2>
                                    <h2 className={css.ttmaq1}>18 C</h2>
                                    ...
                                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/QC_One-Sheet-18C_02.09.21_CMYK.pdf"><a target="_blank"><div className={css.botaosaber}>
