                ...
                <div className={css.ocultamob}>
                    <div className={css.s250}>
                        <Container>
                            <Row>
                                <Col md="5">
                                    <h2 className={css.ttmaq2}>TH 45</h2>
                                    <h2 className={css.ttmaq1}>TH 45</h2>
...
download do catálogo
                                    ...
                                    <Link href="https://s3.us-central-1.wasabisys.com/arquivos.devnx.com.br/pesa/forest/catalogos/LOGSET_TH45_EN_0.pdf"><a target="_blank"><div className={css.botaosaber}>
